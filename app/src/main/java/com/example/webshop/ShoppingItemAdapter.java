...
public class ShoppingItemAdapter extends RecyclerView.Adapter<ShoppingItemAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder( ShoppingItemAdapter.ViewHolder holder, int position) {
        ...
        if(holder.getAdapterPosition() > lastPosition){
            Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.slides);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(ShoppingItem currentItem) {
            ...
            Glide.with(mContext).load(currentItem.getImageResources()).into(mItemImage);

            itemView.findViewById(R.id.add_to_cart).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d("Activity", "Kosár hozzáadása gombra kattintott");
            ...
            itemView.findViewById(R.id.delete).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d("Activity", "Törlés gombra kattintott");
